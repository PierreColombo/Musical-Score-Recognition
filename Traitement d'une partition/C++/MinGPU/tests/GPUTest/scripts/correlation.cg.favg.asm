...
# command line args: -q -profile fp40 -entry favg ARB_draw_buffers NumTemps=32 NumInstructionSlots=4096 MaxLocalParams=512
...
#var float4 favg : $vout.COLOR : COL : -1 : 1
